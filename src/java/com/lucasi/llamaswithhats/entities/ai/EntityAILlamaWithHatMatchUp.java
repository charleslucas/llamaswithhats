...
public class EntityAILlamaWithHatMatchUp extends EntityAIBase
{
    ...
    public EntityAILlamaWithHatMatchUp(EntityLlama p_i47305_1_, double p_i47305_2_)
    {
    ...
    {
    	// If this llama has a parent/lead llama && that parent/lead llama is still alive                && that parent/lead llama still has a parent/lead llama
